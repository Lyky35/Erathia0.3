...
local function creatureSayCallback(cid, type, msg)
	...
	if isInArray({"addon", "outfit"}, msg) then
		if player:getStorageValue(1049) < 1 then
	...
	elseif msgcontains(msg, "faolan") then
		...
		elseif player:getStorageValue(1049) == 8 then
	...
	elseif msgcontains(msg, "task") then
		if player:getStorageValue(1049) == 2 then
			npcHandler:say({
		...
		elseif player:getStorageValue(1049) == 4 then
			npcHandler:say({
		...
		elseif player:getStorageValue(1049) == 6 then
			npcHandler:say({
