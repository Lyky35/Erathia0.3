...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'potion') then
		if player:getStorageValue(1034) < 1 then
	...
	elseif config[msg] and npcHandler.topic[cid] == 0 then
		if player:getStorageValue(1034) == config[msg].storageValue then
	...
	elseif msgcontains(msg, 'secret') then
		if player:getStorageValue(1034) == 8 then
	...
	elseif msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 3 then
			...
			player:setStorageValue(1034, player:getStorageValue(1034) + 1)
