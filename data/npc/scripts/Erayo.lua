...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'addon') then
		if player:hasOutfit(player:getSex() == 0 and 156 or 152) and player:getStorageValue(1035) < 1 then
	...
	elseif config[msg] and npcHandler.topic[cid] == 0 then
		if player:getStorageValue(1035) == config[msg].storageValue then
	...
	elseif msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 2 then
			if player:getStorageValue(1033) ~= 1 then
				player:setStorageValue(1033, 1)
			end
			player:setStorageValue(1035, 1)
		...
		elseif npcHandler.topic[cid] == 3 then
			...
			player:setStorageValue(1035, player:getStorageValue(1035) + 1)
			if player:getStorageValue(1035) == 8 then
