...
local function greetCallback(cid)
	...
	if player:getStorageValue(1037) == 6 then
...
local function creatureSayCallback(cid, type, msg)
	...
	elseif(msgcontains(msg, "fist")) then
		if player:getStorageValue(1037) == 3 then
	...
	elseif(msgcontains(msg, "fighting spirit")) then
		if player:getStorageValue(1037) == 5 then
			if player:getItemCount(5884) >= 1 then
				player:removeItem(5884, 1)
				player:setStorageValue(1037, 6)
	...
	elseif(msgcontains(msg, "cloth")) then
		if player:getStorageValue(1037) == 7 then
	...
	elseif(msgcontains(msg, "yes")) then
		...
		elseif(npcHandler.topic[cid] == 4) then
			...
			player:setStorageValue(1037, 4)
			npcHandler.topic[cid] = 0
		elseif(player:getStorageValue(1037) == 6 and npcHandler.topic[cid] == 0) then
			npcHandler:say({
		...
		elseif(npcHandler.topic[cid] == 10) then
			if player:getItemCount(5885) >= 1 then
				...
				player:setStorageValue(1037, 10)
				npcHandler.topic[cid] = 0
			end
		elseif player:getStorageValue(1037) == 10 then
			...
			player:setStorageValue(1037, 11)
