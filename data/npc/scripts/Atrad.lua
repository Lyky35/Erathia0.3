...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'addon') then
		if player:hasOutfit(player:getSex() == 0 and 156 or 152, 1) and player:getStorageValue(1036) < 1 then
	...
	elseif msgcontains(msg, 'nose ring') then
		if player:getStorageValue(1036) == 1 then
