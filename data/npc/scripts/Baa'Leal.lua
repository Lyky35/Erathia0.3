...
keywordHandler:addKeyword({'hail malor'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Hail to our great leader!"})
...
local function creatureSayCallback(cid, type, msg)
	...
	local player = Player(cid)
	local missionProgress = player:getStorageValue(1097)
	...
	elseif npcHandler.topic[cid] == 1 then
		if msgcontains(msg, 'yes') then
			...
			player:setStorageValue(1086, 1)
			player:setStorageValue(1097, 1)
