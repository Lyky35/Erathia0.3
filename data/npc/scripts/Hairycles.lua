...
local function greetCallback(cid)
	if Player(cid):getStorageValue(2024) < 12 then
...
local function creatureSayCallback(cid, type, msg)
	...
	local questProgress = player:getStorageValue(2024)
	if msgcontains(msg, 'mission') then
		...
		elseif questProgress == 1 then
			if player:getStorageValue(31051) == 1 then
		...
		elseif questProgress == 7 then
			if player:getStorageValue(2028) == 1 then
		...
		elseif questProgress == 13 then
			if player:getStorageValue(2030) == 3 then
				...
				player:setStorageValue(2024, 14)
			else
		...
		elseif questProgress == 15 then
			if player:getStorageValue(31256) == 1 then
		...
		elseif questProgress == 17 then
			if player:getStorageValue(2032) == 1 then
				npcHandler:say({
				...
				player:setStorageValue(2024, 18)
			else
	...
	elseif msgcontains(msg, 'background') then
		if questProgress == 1
				and player:getStorageValue(31051) ~= 1 then
			npcHandler:say({
	...
	elseif msgcontains(msg, 'outfit') or msgcontains(msg, 'shamanic') then
		if questProgress == 18 then
			if player:getStorageValue(2033) ~= 1 then
	...
	elseif npcHandler.topic[cid] == 2 then
		if msgcontains(msg, 'yes') then
			...
			player:setStorageValue(2025, 1)
			player:setStorageValue(2024, 1)
	...
	elseif npcHandler.topic[cid] == 3 then
		if msgcontains(msg, 'yes') then
			if not player:removeItem(4838, 1) then
				...
				player:setStorageValue(31051, -1)
				return true
			end
	...
	elseif npcHandler.topic[cid] == 6 then
		if msgcontains(msg, 'yes') then
			...
			player:setStorageValue(2024, 5)
			player:setStorageValue(2027, 1)
		elseif msgcontains(msg, 'no') then
			npcHandler:say('Me sad. Me expected better from you!', cid)
			addEvent(releasePlayer, 1000, cid)
		end
	...
	elseif npcHandler.topic[cid] == 11 then
		if msgcontains(msg, 'yes') then
			...
			player:setStorageValue(2024, 10)
		elseif msgcontains(msg, 'no') then
	...
	elseif npcHandler.topic[cid] == 12 then
		if msgcontains(msg, 'yes') then
			...
			player:setStorageValue(2024, 11)
			player:setStorageValue(2029, 1)
		elseif msgcontains(msg, 'no') then
			npcHandler:say('Me sad. Me expected better from you!', cid)
			addEvent(releasePlayer, 1000, cid)
		end
	...
	elseif npcHandler.topic[cid] == 13 then
		if msgcontains(msg, 'yes') then
			...
			player:setStorageValue(2024, 12)
			player:setStorageValue(2029, -1)
		elseif msgcontains(msg, 'no') then
	...
	elseif npcHandler.topic[cid] == 14 then
		if msgcontains(msg, 'yes') then
			...
			player:setStorageValue(2024, 13)
			player:setStorageValue(2031, 1)
		elseif msgcontains(msg, 'no') then
	...
	elseif npcHandler.topic[cid] == 15 then
		if msgcontains(msg, 'yes') then
			...
			player:setStorageValue(2024, 15)
		elseif msgcontains(msg, 'no') then
			npcHandler:say('Me sad. Please reconsider.', cid)
		end
		npcHandler.topic[cid] = 0
	...
	elseif npcHandler.topic[cid] == 16 then
		if msgcontains(msg, 'yes') then
			if not player:removeItem(4843, 1) then
				...
				player:setStorageValue(31256, -1)
				return true
			end
			...
			player:setStorageValue(2024, 16)
		elseif msgcontains(msg, 'no') then
			npcHandler:say('You no have hair. You lost it? Go and look again.', cid)
		end
		npcHandler.topic[cid] = 0
	...
	elseif npcHandler.topic[cid] == 17 then
		if msgcontains(msg, 'yes') then
			...
			player:setStorageValue(2024, 17)
