...
local function creatureSayCallback(cid, type, msg)
   ...
   elseif npcHandler.topic[cid] == 3 then
       ...
       if isInArray({"experience", "exp"}, msg:lower()) then
           ...
           player:addExperienceStage((monsterType:getExperience() * 0.6 + 0.6 * player:getCurrentTask()) / player:getStorageValue(2037), true, true)
       ...
       elseif isInArray({"training", "train", "skills"}, msg:lower()) then
           if player:isMage() then
               npcHandler:say("Sorry, but I can only reward mages with experience points or gold. Please choose again, you can have: experience, gold", cid)
               npcHandler.topic[cid] = 3
               return true
           end
           ...
           npcHandler:say("I did not understand that. You can have: experience, gold, or if you want, some training.", cid)
           npcHandler.topic[cid] = 3
           return true
       end
