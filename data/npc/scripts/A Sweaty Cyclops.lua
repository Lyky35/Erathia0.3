...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "fire sword") then
		npc:say("Do lil' one want to trade a fire sword?", TALKTYPE_SAY)
	elseif msgcontains(msg, "bright sword") then
		npc:say("Do lil' one want to trade a bright sword?", TALKTYPE_SAY)
	elseif msgcontains(msg, "warlord sword") then
		npc:say("Do lil' one want to trade a warlord sword?", TALKTYPE_SAY)
	elseif msgcontains(msg, "sword of valor") then
		npc:say("Do lil' one want to trade a sword of valor?", TALKTYPE_SAY)
	elseif msgcontains(msg, "serpent sword") then
		npc:say("Do lil' one want to trade a serpent sword?", TALKTYPE_SAY)
	elseif msgcontains(msg, "enchanted plate") then
		npc:say("Do lil' one want to trade a enchanted plate?", TALKTYPE_SAY)
	elseif msgcontains(msg, "dragon shield") then
		npc:say("Do lil' one want to trade a dragon shield?", TALKTYPE_SAY)
	elseif msgcontains(msg, "bright sword") then
		npc:say("Do lil' one want to trade a bright sword?", TALKTYPE_SAY)
	end
	return true
