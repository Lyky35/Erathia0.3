...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(2005) < 1 then
		...
		elseif player:getStorageValue(2005) == 5 then
		...
		elseif player:getStorageValue(2006) == 2 then
		...
		elseif player:getStorageValue(2007) == 2 then
		...
		elseif player:getStorageValue(2008) == 1 then
			npcHandler:say("Do you bring ONE bone for our officers' safety fund or ALL bones at once?", cid)
			npcHandler.topic[cid] = 12
		elseif player:getStorageValue(2008) == 2 and player:getStorageValue(2009) < 1  then
		...
		elseif player:getStorageValue(2009) == 3 then
		...
		elseif player:getStorageValue(2014) == 2 then
			...
			player:setStorageValue(2014, 3)
			npcHandler.topic[cid] = 0
		end
	elseif msgcontains(msg, "dress pattern") then
		if player:getStorageValue(2010) == 2 then
			...
			player:setStorageValue(2010, 3)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(2010) == 4 then
			...
			player:setStorageValue(2010, 5)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(2010) == 6 then
		...
		elseif player:getStorageValue(2010) == 10 then
			...
			player:setStorageValue(2010, 11)
			npcHandler.topic[cid] = 0
		end
	...
	elseif msgcontains(msg, "advancement") then
		if player:getStorageValue(2008) == 2 and player:getStorageValue(2015) == 1 then
			npcHandler:say("You are worthy indeed. Do you want to advance in our guild?", cid)
			npcHandler.topic[cid] = 14
		elseif player:getStorageValue(2010) == 13 and player:getStorageValue(2015) == 2 then
			npcHandler:say("You are worthy indeed. Do you want to advance in our guild?", cid)
			npcHandler.topic[cid] = 20
		elseif player:getStorageValue(2012) == 3 and player:getStorageValue(2015) == 3 then
			npcHandler:say("You are worthy indeed. Do you want to advance in our guild?", cid)
			npcHandler.topic[cid] = 24
		elseif player:getStorageValue(2014) == 3 and player:getStorageValue(2015) == 4 then
			npcHandler:say("You are worthy indeed. Do you want to advance in our guild?", cid)
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[cid] == 8 then
			...
			player:setStorageValue(2005, 6)
			player:setStorageValue(2006, 1)
			npcHandler.topic[cid] = 0
		...
		elseif npcHandler.topic[cid] == 10 then
			...
			player:setStorageValue(2006, 3)
			player:setStorageValue(2007, 1)
		...
		elseif npcHandler.topic[cid] == 11 then
			...
			player:setStorageValue(2007, 3)
			player:setStorageValue(2008, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 13 then
			if getPlayerBones(cid) >= 20 then
				...
				player:setStorageValue(2008, 2)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("Come back when you have all 20 bones.", cid)
				npcHandler.topic[cid] = 0
			end
		...
		elseif npcHandler.topic[cid] == 16 then
			...
			player:setStorageValue(2009, 4)
			player:setStorageValue(2010, 1)
			npcHandler.topic[cid] = 0
		...
		elseif npcHandler.topic[cid] == 19 then
			...
			player:setStorageValue(2010, 13)
			player:setStorageValue(2011, 1)
			npcHandler.topic[cid] = 0
		...
		elseif npcHandler.topic[cid] == 22 then
			...
			player:setStorageValue(2011, 8)
			player:setStorageValue(2012, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 23 then
			...
			player:setStorageValue(2012, 3)
			player:setStorageValue(2013, 0)
			npcHandler.topic[cid] = 0
		...
		elseif npcHandler.topic[cid] == 26 then
			...
			player:setStorageValue(2013, 4)
			player:setStorageValue(2014, 1)
		...
		elseif npcHandler.topic[cid] == 27 then
			...
			player:setStorageValue(2015, 5)
			player:setStorageValue(2016, 1)
			npcHandler.topic[cid] = 0
		end
	end
	return true
