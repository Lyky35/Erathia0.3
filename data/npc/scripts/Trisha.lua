...
function greetCallback(cid)
	...
	if player:isKnight() then
		npcHandler:setMessage(MESSAGE_GREET, "Welcome back, knight ".. player:getName() .."!")
	else
		npcHandler:setMessage(MESSAGE_GREET, "Salutations, ".. player:getName() ..". What can I do for you?")
	end	
	return true
end
...
local function creatureSayCallback(cid, type, msg)
	...
	local player, storage = Player(cid), 1075
