...
addTravelKeyword('edron', 'Do you seek a ride to Edron for |TRAVELCOST|?', 60, Position(33193, 31783, 3), nil, function(player) if player:getStorageValue(2005) == 2 then player:setStorageValue(2005, 3) end end)
...
keywordHandler:addKeyword({'ride'}, StdModule.say, {npcHandler = npcHandler, text = "I can fly you to Darashia on Darama, Kazordoon, Svagrond or Edron if you like. Where do you want to go?"})
