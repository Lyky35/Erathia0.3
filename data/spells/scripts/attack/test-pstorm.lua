...
conditionParalyze:setFormula(0.3, -64, 0.3, -64)

local conditionPoison = Condition(CONDITION_POISON)
conditionPoison:setParameter(CONDITION_PARAM_DELAYED, 1)
conditionPoison:addDamage(2, 4000, -120)
conditionPoison:addDamage(3, 4000, -80)
conditionPoison:addDamage(4, 4000, -60)
conditionPoison:addDamage(5, 4000, -30)
conditionPoison:addDamage(6, 5000, -20)
conditionPoison:addDamage(7, 5000, -10)
conditionPoison:addDamage(8, 5000, -8)
conditionPoison:addDamage(9, 5000, -4)
conditionPoison:addDamage(10, 5000, -2)
conditionPoison:addDamage(11, 5000, -1)
