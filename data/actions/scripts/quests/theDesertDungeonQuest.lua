local config = {
	{fromPosition = Position(32677, 32089, 8), toPosition = Position(32679, 32089, 8), sacrificePosition = Position(32679, 32089, 8), sacrificeId = 2175, vocationId = 1},
	{fromPosition = Position(32669, 32089, 8), toPosition = Position(32667, 32089, 8), sacrificePosition = Position(32667, 32089, 8), sacrificeId = 2674, vocationId = 2},
	{fromPosition = Position(32673, 32085, 8), toPosition = Position(32673, 32083, 8), sacrificePosition = Position(32673, 32083, 8), sacrificeId = 2455, vocationId = 3},
	{fromPosition = Position(32673, 32093, 8), toPosition = Position(32673, 32094, 8), sacrificePosition = Position(32673, 32094, 8), sacrificeId = 2376, vocationId = 4}
}
